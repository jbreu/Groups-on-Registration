...
/**
 * Groups on Registration Notification class.
 */
class demo extends \phpbb\notification\type\base
{
	...
	{
		return 'jbreu.groupsonregistration.notification.type.demo';
	}
	...
	{
		return $this->helper->route('jbreu_groupsonregistration_controller', $this->get_data('acme_demo'));
	}
